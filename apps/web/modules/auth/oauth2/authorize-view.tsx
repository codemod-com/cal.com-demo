...
const { t } = useTranslation("../../../tmp/i6o6wu/apps/web/modules/auth/oauth2");
          ...
          <div className="relative -ml-6 h-24 w-24">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-default flex h-[70px] w-[70px] items-center  justify-center rounded-full">
                <img src="/cal-com-icon.svg" alt={t('logo-key')} className="h-16 w-16 rounded-full" />
              </div>
            </div>
          </div>
        </div>
