...
const { t } = useTranslation("../modules/event-types/views");
        ...
        <ConfirmationDialogContent
          ...
          <p className="mt-5">
            <Trans
              ...
              <ul>
                <li>{t('members-assigned-to-event-type-deleted')}</li>
                <li>{t('shared-link-no-longer-able-to-book')}</li>
              </ul>
            </Trans>
          </p>
        </ConfirmationDialogContent>
...
const { t } = useTranslation("../modules/event-types/views");
  ...
  return (
    <Shell
      ...
      <HeadSeo
        title={t('event-types')}
        description={t('create-events-to-share-for-booking')}
      />
