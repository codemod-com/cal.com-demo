      ...
      <div className="max-w-screen-lg">
        {doesUserHaveOrgToUpgrade.data ? (
          <EmptyScreen
            ...
            description={t('improve-your-scheduling-experience-by-upgrading-to-the-new-plan-and-enjoy-the-new-features')}
          ...
          <EmptyScreen
            ...
            description={t('you-are-already-on-the-latest-plan-nothing-to-upgrade-enjoy-the-new-features-and-reach-out-to-us-with-any-questions')}
            Icon="circle-check"
