...
const { t } = useTranslation("../../../tmp/i6o6wu/apps/web/modules/settings/platform");
  ...
  if (isUserLoading || isOAuthClientLoading) return <div className="m-5">{t('loading-message-0')}</div>;

  if (isUserBillingDataLoading && !userBillingData) {
    return <div className="m-5">{t('loading-message-1')}</div>;
  }
