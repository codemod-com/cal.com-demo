...
const { t } = useTranslation("../modules/settings/platform/plans");
  ...
  return (
    <div>
      <Shell
        ...
        isPlatformUser={true}
        heading={
          <h1 className="mx-2 mt-4 text-center text-xl md:text-2xl">{t('you-are-currently-subscribed-to')}{userBillingData?.plan[0]}
