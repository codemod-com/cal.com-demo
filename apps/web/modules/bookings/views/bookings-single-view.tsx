...
const { t } = useTranslation("../../../tmp/i6o6wu/apps/web/modules/bookings/views");
                  ...
                  <>
                    <div
                      ...
                      {giphyImage && !needsConfirmation && isReschedulable && (
                        ...
                        <img src={giphyImage} className="w-full rounded-lg" alt={t('gif-from-giphy')} />
                      )}
                      <div
                        className={classNames(
                          ...
                          <div className="justify-left mt-1 flex text-left sm:mt-0">
                            ...
                            <Link
                              ...
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                                <title>{t('microsoft-outlook')}</title>
                            ...
                            <Link
                              ...
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                                <title>{t('microsoft-office')}</title>
                        ...
                        <div className="text-default pt-8 text-center text-xs">
                          ...
                          <form
                            ...
                            <EmailInput
                              ...
                              placeholder={t('rick-astley-cal-com')}
                            />
                            <Button
                              size="lg"
                              type="submit"
                  ...
                  (noShow ? (
                    ...
                    <>
                      ...
                      <TextArea
                        id="comment"
                        name="comment"
                        placeholder={t('next-time-i-would-like-to')}
                        rows={3}
                        disabled={isFeedbackSubmitted}
