...
type AppPageType = {
    ...
    default: ((props: any) => JSX.Element) & Pick<AppProps["Component"], "isBookingPage" | "getLayout" | "PageWrapper">;
};
...
export async function getServerSideProps(context: GetServerSidePropsContext<{
    ...
    if (route.getServerSideProps) {
        ...
        const result = await route.getServerSideProps(context as GetServerSidePropsContext<{
            slug: string;
            pages: string[];
            appPages: string[];
        }>, prisma, user, ssrInit);
