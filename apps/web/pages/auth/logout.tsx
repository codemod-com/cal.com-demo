...
export function Logout(props: Props) {
    ...
    return (<AuthContainer title={t("logged_out")} description={t("youve_been_logged_out")} showLogo>
      <div className="mb-4">
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
    ...
    context.res.setHeader("Set-Cookie", "next-auth.session-token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;");
