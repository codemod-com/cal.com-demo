...
export default function ForgotPassword({ csrfToken }: {
    ...
    const Success = () => {
        return (<div className="space-y-6 text-sm leading-normal ">
    ...
    return (<AuthContainer showLogo title={!success ? t("forgot_password") : t("reset_link_sent")} heading={!success ? t("forgot_password") : t("reset_link_sent")} description={t("request_password_reset")} footerText={!success && (<>
      ...
      {!success && (<>
          ...
          <form className="space-y-6" onSubmit={handleSubmit} action="#" style={{
                "--cal-brand": "#111827",
            ...
            <EmailField onChange={handleChange} id="email" name="email" label={t("email_address")} placeholder="john.doe@example.com" required/>
            <div className="space-y-2">
              <Button className="w-full justify-center" type="submit" disabled={loading} aria-label={t("request_password_reset")} loading={loading}>
