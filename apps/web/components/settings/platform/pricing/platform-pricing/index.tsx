...
const { t } = useTranslation("../../../tmp/i6o6wu/apps/web/components/settings/platform/pricing/platform-pricing");
  ...
  if (!teamId) {
    return <div className="m-5">{t('platform-team-not-present-you-need-to-create-a-team-first')}</div>;
  }
