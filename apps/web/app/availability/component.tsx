...
export function AvailabilityPage_() {
  const { t } = useLocale();
...
export function AvailabilityPage__() {
  return <PageWrapper pageProps={{}} router={{}} Component={AvailabilityPage_} />;
}

export const AvailabilityPage = trpc.withTRPC(AvailabilityPage__);
