...
test.describe("free user", () => {
  ...
  test("sees proper metadata", async ({ page }) => {
...

    {
      ...
      await expect(locator).toHaveAttribute("content", page.url());
    }
...

    {
      ...
      await expect(locator).toHaveAttribute("href", page.url());
    }

    {
      ...
      expect(content).toEqual(`${freeUserObj.name} | Cal.com`);
    }
...

    {
      ...
      expect(innerText).toEqual(`${freeUserObj.name} | Cal.com`);
    }
