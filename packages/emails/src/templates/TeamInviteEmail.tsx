...
i18nKey="invited-by-added-to-organization"
...
i18nKey="invited-by-invited-to-organization"
values={{ invitedBy, _teamName_: <>{teamName}</> }}
components={{"0": <strong />}}
/></Trans>{" "}
                <Trans
...
/><br />
      ...
      return (
        <>
          {autoJoinType === "added" ? (
            <Trans i18nKey="email_team_invite|content|added_to_org"><Trans
i18nKey="invited-by-added-to-organization-duplicate"
values={{ invitedBy, _teamName_: <>{teamName}</> }}
components={{"0": <strong />}}
/></Trans>
          ) : (
            <Trans i18nKey="email_team_invite|content|invited_to_org"><Trans
i18nKey="invited-by-invited-to-organization-duplicate"
values={{ invitedBy, _teamName_: <>{teamName}</> }}
components={{"0": <strong />}}
/></Trans>
          )}{" "}
