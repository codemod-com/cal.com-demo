    ...
    <BaseEmailHtml
      ...
      <>
        <Trans i18nKey="hi_user_name" name={name}>
          <p style={{ fontWeight: 400, lineHeight: "24px", display: "inline-block" }}>{t('greeting-hi-name', { name })}</p>
          <p style={{ display: "inline" }}>,</p>
        </Trans>
        <Trans i18nKey="email_body_slug_replacement_notice" slug={slug}>
          <p style={{ fontWeight: 400, lineHeight: "24px" }}><Trans
i18nKey="admin-replaced-event-type-team-name-slug"
...
/></p>
        ...
        <Trans i18nKey="email_body_slug_replacement_info">
          <p style={{ fontWeight: 400, lineHeight: "24px" }}>{t('link-settings-changed-review-event-types')}</p>
        </Trans>
        <table
          role="presentation"
          border={0}
        ...
        <Trans i18nKey="email_body_slug_replacement_suggestion">
          <p style={{ fontWeight: 400, lineHeight: "24px" }}>{t('questions-event-type-reach-out-administrator')}<br />
