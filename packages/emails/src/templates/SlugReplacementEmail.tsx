...
/></p>
        ...
        <Trans i18nKey="email_body_slug_replacement_info">
          <p style={{ fontWeight: 400, lineHeight: "24px" }}>{t('your-link-will-continue-to-work-but-some-settings-may-have-changed')}</p>
        </Trans>
        <table
          role="presentation"
          border={0}
        ...
        <Trans i18nKey="email_body_slug_replacement_suggestion">
          <p style={{ fontWeight: 400, lineHeight: "24px" }}>{t('if-you-have-questions-about-the-event-type-reach-out-to-your-administrator')}<br />
