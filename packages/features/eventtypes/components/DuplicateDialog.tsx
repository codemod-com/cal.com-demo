...
import { Button, Dialog, DialogClose, DialogContent, Form, showToast, TextAreaField, TextField, } from "@calcom/ui";
      ...
      <DialogContent type="creation" className="overflow-y-auto" title="Duplicate Event Type">
        <Form form={form} handleSubmit={(values) => {
          ...
          <div className="mt-3 space-y-6">
            ...
            <TextAreaField label={t("description")} placeholder={t("quick_video_meeting")} {...register("description")}/>
