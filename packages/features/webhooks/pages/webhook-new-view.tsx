...
const NewWebhookView = () => {
    ...
    const subscriberUrlReserved = (subscriberUrl: string, id?: string): boolean => {
        return !!webhooks?.find((webhook) => webhook.subscriberUrl === subscriberUrl && (!id || webhook.id !== id));
    };
    ...
    return (<>
      <Meta title={t("add_webhook")} description={t("add_webhook_description", { appName: APP_NAME })} backButton/>
