...
const { t } = useTranslation("../../../tmp/i6o6wu/packages/app-store-cli/src/components");
        ...
        {status === "done" && (
          <Box flexDirection="column" paddingTop={2} paddingBottom={2}>
            ...
            <Box flexDirection="column">
              ...
              <Text bold>{t('next-step-enable-the-app-from-http-localhost-3000-settings-admin-apps-as-admin-user')}</Text>
            </Box>
          </Box>
        )}
