...
const { t } = useTranslation("../../../../tmp/i6o6wu/packages/platform/examples/base/src/pages");
  ...
  return (
    <main
      ...
      <h1 className="my-4 text-2xl font-semibold">{props.calUsername}{t('bookings')}</h1>
          ...
          return (
            <div
              ...
              <div>
                ...
                <div className="px-6">
                  <p>
                    {booking?.hosts?.[0]?.name}{t('and')}{booking.attendees[0].name}
                  </p>{" "}
                  <p />
                </div>
              </div>
