...
function CategoryTab({ selectedCategory, categories, searchText }: CategoryTabProps) {
    ...
    return (<div className="relative mb-4 flex flex-col justify-between lg:flex-row lg:items-center">
      ...
      {leftVisible && (<button onClick={handleLeft} className="absolute bottom-0 flex md:left-1/2 md:-top-1">
...
export function AllApps({ apps, searchText, categories }: AllAppsPropsType) {
    ...
    return (<div>
      ...
      {filteredApps.length ? (<div className="grid gap-3 lg:grid-cols-4 [@media(max-width:1270px)]:grid-cols-3 [@media(max-width:730px)]:grid-cols-1 [@media(max-width:500px)]:grid-cols-1" ref={appsContainerRef}>
