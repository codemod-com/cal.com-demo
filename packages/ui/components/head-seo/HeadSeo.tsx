...
export const HeadSeo = (props: HeadSeoProps): JSX.Element => {
    ...
    const isCalcom = url && (new URL(url).hostname.endsWith("cal.com") || new URL(url).hostname.endsWith("cal.dev"));
    ...
    const { title, description, siteName, canonical = defaultUrl, nextSeoProps = {}, app, meeting, isBrandingHidden, } = props;
