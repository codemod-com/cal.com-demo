...
const { t } = useTranslation("../../../tmp/i6o6wu/packages/ui/components/form/toggleGroup");
  ...
  return (
    <ToggleGroupPrimitive
      ...
      <ToggleGroupItemPrimitive
        ...
        disabled={disabled}
        value="yes">{t('yes')}</ToggleGroupItemPrimitive>

      <ToggleGroupItemPrimitive
        disabled={disabled}
        className={classNames(!boolean(yesNoValue) ? selectedClass : unselectedClass)}
        value="no">{t('no')}</ToggleGroupItemPrimitive>
    </ToggleGroupPrimitive>
  );
};
